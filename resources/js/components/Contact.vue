<template>
  <form class="form mt-10" action="#" @submit.prevent="sendContact">
    <div class="form__row">
      <div class="form__input-group">
        <div class="form__label-group">
          <p><label for="name" class="">Nome <abbr title="Obrigatório">*</abbr></label></p>
    ...
    <div class="form__row">
      <div class="form__input-group">
        <div class="form__label-group">
          <p><label for="email" class="">E-mail <abbr title="Obrigatório">*</abbr></label></p>
    ...
    <div class="form__row">
      <div class="form__input-group">
        <div class="form__label-group">
          <p><label for="name" class="">Assunto <abbr title="Obrigatório">*</abbr></label></p>
